...
export default function PenguinListCopy() {
...
// MATERIAL UI
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, penguinReducer.length - page * rowsPerPage);
                ...
                <TableContainer>
                    ...
                    >
                        <EnhancedTableHead
                            ...
                            rowCount={penguinReducer.length}
                        />
                        <TableBody>
                            {stableSort(penguinReducer, getComparator(order, orderBy))
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.colony_name}</TableCell>
                                            <TableCell align="right">{row.average}</TableCell>
                                            <TableCell align="right"><Button variant="contained" color="primary" onClick={() => handlePenguinDetails(row)}>Penguin Details</Button></TableCell>
                                            <TableCell align="right"><Button variant="contained" color="primary" onClick={() => handlePenguinEdit(row)}>Edit</Button></TableCell>
                                            <TableCell align="right"><Button variant="contained" color="secondary" onClick={() => handlePenguinDelete(row)}>Delete</Button></TableCell>
